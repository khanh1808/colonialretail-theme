  ...
  if ( $attachment_ids || $render_without_attachments ) {
    ...
    <div class="<?php echo implode(' ', $gallery_class); ?>"
        ...
        <div class="col is-nav-selected first">
          <a>
            <?php
              ...
              $image =  wp_get_attachment_image_src( $image_id, apply_filters( 'woocommerce_gallery_thumbnail_size', 'large' ) );
      ...
      foreach ( $attachment_ids as $attachment_id ) {
        ...
        $image =  wp_get_attachment_image_src( $attachment_id, apply_filters( 'woocommerce_gallery_thumbnail_size', 'large' ));
